...
void PageTableManager::MapMemory(void* virtualMemory, void* physicalMemory)
{
    ...
    if(!PDE.GetFlag(PT_Flag::Present)){
        ...
        PDP = (PageTable*)((uint64_t)PDE.GetAddress() << 12); //assign logical address to PDE
    }
    ...
    if(!PDE.GetFlag(PT_Flag::Present)){
        ...
        PD = (PageTable*)((uint64_t)PDE.GetAddress() << 12); //assign logical address to PDE
    }
    ...
    if(!PDE.GetFlag(PT_Flag::Present)){
        ...
        PT = (PageTable*)((uint64_t)PDE.GetAddress() << 12); //assign logical address to PDE
    }
